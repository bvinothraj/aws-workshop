...
def download_with_threads(bucket_name, object_key, download_file_path, file_size_mb):
    """
...
class TransferDemoManager:
    ...
    def demo(self, question, upload_func, download_func, upload_args=None, download_args=None):
        ...
        if answer.lower() == 'y':
            ...
            self._config_wrapper(TransferConfig, CONFIG_ATTRS + DOWNLOAD_CONFIG_ATTRS)
...
def main():
    ...
    demo_manager.demo(
        ...
        "then download the same file using multi threads?",
